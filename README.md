...
note.dismissalDate = Math.floor(Date.now() / 1000); // Current time
note.event = "update"
note.contentState = {}
```
...
```json
{"messageFrom":"John Appleseed","aps":{"badge":3,"sound":"ping.aiff","alert":"\uD83D\uDCE7 \u2709 You have a new message", "relevance-score":75,"timestamp":1683129662,"stale-date":1683216062,"dismissal-date":1683129662,"events":"update","content-state":{}}}
```
